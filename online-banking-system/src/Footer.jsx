...
const Footer = () => {
  ...
  return (
    <div className="formOuter h-[70vh] flex-col">
      ...
      <section className="h-40 w-full bg-blue-500 text-white display-flex justify-evenly">
        <aside>
      ...
      <div className="h-100 w-full bg-blue-950 text-white display-flex-col">
        <section className="display-flex justify-evenly gap-15">
          ...
          <aside
            className="h-65 w-100 display-flex-col justify-start
          items-start px-5 gap-5"
          >
