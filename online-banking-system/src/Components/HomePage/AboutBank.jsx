  ...
  return (
    <div className="h-[70vh] w-full display-flex-col justify-evenly mb-10">
      ...
      <div className="display-flex w-full font-bold text-3xl">
        <h1>
          Simple Banking ,
          <h1 className="inline italic text-blue-500">Seriously</h1>
        </h1>
      </div>
      {/* Info */}
      <p className="w-270 text-justify">
      ...
      <div className="h-60 w-280 display-flex justify-evenly">
        ...
        <div className="aboutCards">
          <i className="fa-solid fa-users aboutIcon"></i>
        ...
        <div className="aboutCards">
          ...
          <h1 className="font-bold text-3xl">2026</h1>
          <p className="font-medium">Founded with a mission</p>
        </div>
        {/* Card - 3 */}
        <div className="aboutCards">
          <i className="fa-regular fa-heart aboutIcon"></i>
